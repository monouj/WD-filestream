...
const BOT_TOKEN = "5853354544:AAFkDd7rxX8nXNmmBSDVElycQZZQ7tth6x8"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "LEO"; // Insert a powerful secret text.
const BOT_OWNER = 1350212613; // Insert your telegram account id.
const BOT_CHANNEL = -1001583883335; // Insert your telegram channel id which the bot is admin in.
const SIA_NUMBER = 325610; // Insert a random integer number and keep it safe.
